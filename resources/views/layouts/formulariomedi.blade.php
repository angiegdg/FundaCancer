						...
						<div class="top-nav">
							...
							<ul id="menu">
								...
								<ul>
									...
									<li><a href="{{ url('/fundacion/medicamento')}}">Medicamentos</a>
								</ul>
							</li>
				...
				<div class="donate-main">
					...
					<div class="col-md-8 donate-right">
						<div class="donate-top">
							...
							<form method="POST" action="{{url('fundacion/medicamento')}}">
					...
					<div class="col-md-4 donate-left">
						...
						<br>
						<select name="" id="" style="background: white;" multiple> 
							@foreach($Medica as $issue)
							 <option  style="color: #000;">{{$issue->nombre}}</option>
						    @endforeach
						</select> 
				    </div>
				<div class="clearfix"> </div>
