				...
				<div class="top-nav">
					<span class="menu"> </span>
						<ul id="menu">
							...
							<li><a class="active" href="blog.html">Niños</a> 
...
<!--/start-services-->
			 <div class="what-section">
				...
				<div class="col-md-4 serve-column">
					<i class="book"></i>
					<h4>Donaciones</h4>
					<p>Encuentra aquí la lista de medicamentos e insumos que han sido donado a nuestros niños</p>
					<a class="offer-btn" href="#"><lable></lable>Más info</a>
				</div>
				<div class="col-md-4 serve-column">
					<i class="fam"></i>
					<h4>Medicamentos e insumos</h4>
					<p>Encuentra aquí la lista de medicamentos e insumos que se necesitan para nuestros niños</p>
					<a class="offer-btn" href="#"><lable></lable>Más info</a>
				</div>
				<div class="col-md-4 serve-column ">
					<i class="bel"></i>
					<h4>Cancer por niño</h4>
					<p>Encuentra aqui los tipos de cancer por niño</p>
					<a class="offer-btn" href="#"><lable></lable>Más info</a>
				</div>
				<div class="clearfix"></div>
			</div>
	...
	<div class="portfolios entertain_box  wow fadeInUp" data-wow-delay="0.4s" id="project">
		<div class="container">
			...
			<ul id="filters" class="clearfix">
						<li><span class="filter active" data-filter="app card icon logo web"> Ver todos </span></li>
						<li><span class="filter" data-filter="app">CATEGORIA 1</span></li>
						<li><span class="filter" data-filter="photo">CATEGORIA 2</span></li>
						<li><span class="filter" data-filter="card">CATEGORIA 3</span></li>
					</ul>
